...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="relative min-h-screen bg-white text-black">
      <StatusBar />
      <div className="animation-delay-8 animate-fadeIn mt-20 flex flex-col items-center justify-center px-4 text-center md:mt-20">
        ...
        <div className="mb-10 mt-4 md:mt-6">
          <div className="px-2">
            <div className="relative mx-auto h-full max-w-7xl border border-black p-6 md:px-12 md:py-20">
